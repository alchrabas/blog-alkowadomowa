...
Pierwszy pomysł na piwo bezalkoholowe był prosty: wziąć tę samą brzeczkę z filtrowania słodu i rozwodnić do 2 Blg (miara zawartości cukru). Da to piwo zawierające maksymalnie pół procenta alkoholu, a powinno wciąż zawierać 1/10 smaku prawdziwego piwa. Jako bazę wykorzystałem brzeczkę z piwa [z tego przepisu](https://web.archive.org/web/20241004082644/https://www.wiki.piwo.org/Full_Aroma_Hops_,_Carlberg_(wersja_na_20l)). Dodatkowo rozwadnianą brzeczkę brałem z końcówki wysładzania, dzięki czemu uzyskiwałem brzeczkę przed rozwadnianiem pomiędzy 2 a 6 Blg. Średnio wyszło z tego 4 Blg, więc musiałem dolać drugie tyle wody. W zamierzeniu powinno dać to nieco goryczy z białek. Już wizualnie dało się ocenić, że będzie bardzo wodniste.

![filtracja brzeczki po zacieraniu]({attach}zacieranie.jpg)
...
Można poczytać o tym po angielsku na stronie [Brewness](https://www.brewingwithbriess.com/blog/cold-extraction-of-malt-components-and-their-use-in-brewing-applications/).

# Piwo #3 - Full Aroma Hops z dodatkami

Na kolejne podejście zdecydowałem się spróbować piwa, które poprzedniego lata bardzo odpowiadało mi w wersji alkoholowej ([link do archiwum internetu](https://web.archive.org/web/20241004082644/https://www.wiki.piwo.org/Full_Aroma_Hops_,_Carlberg_(wersja_na_20l)), bo [oryginał zniknął z wiki piwo.org](https://www.wiki.piwo.org/Full_Aroma_Hops_,_Carlberg_%28wersja_na_20l%29)). Swoją drogą jest to to samo piwo, na podstawie którego próbowałem zrobić pierwsze, wodniste piwo bezalkoholowe.
...
![Po lewej pieprz syczuański]({attach}pieprz.jpg)

![Wszystkie gąsiory]({attach}warianty.jpg)

![Piana na pierwszym piwie]({attach}fah.jpg)
...
![Odwrócony hop spider]({attach}reverse-hop-spider.jpg)
...
![Butelkowanie stouta]({attach}stout-butelkowanie.jpg)
...
Dolana woda by wyszło 5 gąsiorów. Do każdego na chmielenie na zimno po 2g chmielu lubelskiego na gąsior 5L:
 ...
 - kola 15 g orzeszków/5L - inspirowałem się [klonem Fortuny Czarnej](https://brewness.com/pl/recipe/fortuna-czarne-klon/view)
 - herbata 10g/5L
